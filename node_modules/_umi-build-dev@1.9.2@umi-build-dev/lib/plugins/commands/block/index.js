  ...
  function _add() {
    _add = _asyncToGenerator(function* (args = {}) {
      ...
      if (skipDependencies) {
        ...
        const allBlockDependencies = (0, _getBlockGenerator.getAllBlockDependencies)(ctx.templateTmpDirPath, ctx.pkg); // get confilict dependencies and lack dependencies

        const _applyPlugins = applyPlugins('_modifyBlockDependencies', {
          initialValue: (0, _getBlockGenerator.dependenciesConflictCheck)(allBlockDependencies, projectPkg.dependencies, devDependencies, _objectSpread({}, projectPkg.devDependencies, projectPkg.dependencies))
        }),
